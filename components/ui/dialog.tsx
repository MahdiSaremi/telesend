  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <div className="fixed top-0 left-0 w-screen h-screen z-50 overflow-y-auto">
        <div className="w-screen min-h-screen flex items-center justify-center py-4">
          <DialogPrimitive.Content
            data-slot="dialog-content"
            className={cn(
              "bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 grid w-full max-w-[calc(100%-2rem)] gap-4 rounded-xl p-6 shadow-xl duration-200 sm:max-w-lg",
              className
            )}
            {...props}
          >
